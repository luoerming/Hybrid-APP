...
// INSERT POINT: _end
	...
	refresh: function () {
		...
		//add by 添加一个minScrollY属性，如果有则 = 该值，否则等于0；
		//该值 = pulll的高
...
function createDefaultScrollbar (direction, interactive, type) {
	...
	if ( type === true ) {
		scrollbar.style.cssText = 'position:absolute;z-index:1';
		
		//mdy by 564539969@qq.com
		//更改滚动条颜色,新版本出来之后可以在外面自定义滚动条样式,这里即可去掉
		indicator.style.cssText = '-webkit-box-sizing:border-box;-moz-box-sizing:border-box;box-sizing:border-box;position:absolute;background:rgba(173, 173, 173, 1)';
	}
